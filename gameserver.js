				...
				try {
					...
					switch (msgType) {
						...
						case 26:
							...
							if (((TESTING || ws.isdeveloper) && !ws.player.flags.includes(87) && ws.player.arenaid == 0 && !tourneylist.includes(ws.player.id) && ws.player.hp > ws.player.maxhp * 0.15) || ws.isdeveloper) {
