...
utils.prototype = {
    ...
    anitoxp: function (animal) {
        var xp = 0;
        kdtier = [79,46]
        monsters = [78,73,71,76,70,72]
        apexes = [85,80,14,77,53,68,24,32,61]
        eletier = [48,52,56,59,65,43]
        orcatier = [26,13]
        if (kdtier.includes(animal)) return 30000000;
        if (monsters.includes(animal)) return 10000000;
        if (apexes.includes(animal)) return 1000000;
        if (eletier.includes(animal)) return 500000;
        if (orcatier.includes(animal)) return 250000;
        else return 1000000;
    },
}
